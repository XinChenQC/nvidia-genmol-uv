...
print('Linker Design')
fragment = '[11*]N1CCCC1.[17*]c1ccc2c(c1)OCCO2'
samples = sampler.fragment_linking(fragment, num_samples, randomness=3)
print(samples)

print('One-step Linker Design')
samples = sampler.fragment_linking_onestep(fragment, num_samples, randomness=3)
print(samples)
